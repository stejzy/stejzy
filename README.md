...
**`Junior Software Engineer | CS Student @ PŁ`**

Junior Software Engineer specializing in **React, Node.js, and TypeScript**.
I enjoy replacing off-the-shelf SaaS solutions with custom-built, high-performance code.
Currently pursuing my Master's degree in Computer Science (Software Engineering & Machine Learning).
...
<img align="left" alt="Express" width="26px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg" style="margin-right:10px; filter: drop-shadow(0px 0px 2px #fff) drop-shadow(0px 0px 2px #fff);" />
...
<img align="left" alt="Prisma" width="26px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/prisma/prisma-original.svg" style="margin-right:10px;" />
